...
import { LinkedinIcon, CameraIcon, HomeIcon, BuildingIcon, GlobeIcon, MapPinIcon, UsersIcon } from 'lucide-react';
...
const CompanyProfile = () => {
  ...
  const internTypes = [
    ...
    // Function to submit the profile data to the backend
    ...
    // ✅ Show error message if the API fails
    if (error) {
      return (
    ...
    // ✅ If profile is already complete, show a success message instead of the form
   
    if (profileComplete) {
      return (
        <div className="flex flex-col items-center  min-h-screen bg-gray-50">
          <div className="bg-gray-50  p-6 rounded-lg text-center">
            <h1 className="text-3xl font-semibold text-teal-600">Profile Completed 🎉</h1>
            <p className="text-gray-600 mt-4">
              Your company profile is fully set up. You can now explore other features.
            </p>
            <a
              href="/dashboard"
              className="mt-6 inline-block px-6 py-3 text-white bg-teal-500 rounded-lg hover:bg-teal-600 transition"
            >
              Go to Dashboard
            </a>
          </div>
