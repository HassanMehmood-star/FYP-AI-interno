  ...
  return (
    <div className="relative">
      ...
      <div
        className={`${
          isOpen ? 'block' : 'hidden'
        } lg:block w-60 bg-[#1F2937] text-white flex flex-col rounded-l-lg rounded-r-lg shadow-lg mt-4 mb-4 ml-4 lg:static absolute z-40 transition-all duration-300 overflow-y-auto max-h-screen`} // Removed h-[94vh], added overflow-y-auto and max-h-screen
      >
        {/* Sidebar Header */}
        ...
        <div className="flex flex-col items-start px-3 py-4 space-y-3">
          ...
          {/* Program Menu with Submenu */}
          <div className="w-full">
            <button
              onClick={toggleProgramMenu}
              className="flex items-center justify-between w-full py-2 px-4 text-lg font-medium rounded-lg text-gray-200 hover:bg-[#374151] transition duration-300"
            >
              ...
              {isProgramOpen ? <FaChevronUp /> : <FaChevronDown />}
            </button>
          ...
          {/* Logout Button */}
          <div className="w-full px-6 mt-6 mb-4"> {/* Removed absolute positioning, added margin */}
            <button
