...
/>
               ...
               <button onClick={handleSubmit}
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="w-6 h-6 -ml-2">
                ...
                <p className="mt-6 text-sm text-gray-600 text-center">
                 ...
                 <a href="" className="text-indigo-600 hover:text-blue-700">
                       Login
                    </a>
...
export default User_Emailverification
